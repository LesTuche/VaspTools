...
# TODO make sure that all folders are created by the script/ that expected path names are consitent
# TODO make a dict which is checked before we download something also a "DB" in home which store used poscars
